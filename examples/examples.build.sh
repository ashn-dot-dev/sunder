...
if command -v clang >/dev/null; then
    ...
    echo $CMD
    eval $CMD
    CMD="SUNDER_BACKEND=C SUNDER_CC=clang ${SUNDER_HOME}/bin/sunder-compile -c -o ffi/calling-c-from-sunder.o ffi/calling-c-from-sunder.sunder"
    echo $CMD
    eval $CMD
    ...
    CMD="SUNDER_BACKEND=C SUNDER_CC=clang ${SUNDER_HOME}/bin/sunder-compile -c -o ffi/sunder-code.o ffi/calling-sunder-from-c.sunder"
    echo $CMD
    eval $CMD
